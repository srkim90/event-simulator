...
public class DomsCreateCompanyProducer extends BaseProducer {
    ...
    /* 1. DNS 등록
        ...
        -> 응답 데이터 수신 방법 : 콜백 (비동기)
    **/
    public void sendArecordDnsRegistrationMessage(ARecordRegisterModel requestModel, AmqRoutingInfo requestRoutingInfo) {
    ...
    /* 2. DO 회사 생성
        ...
        -> 응답 데이터 수신 방법 : 콜백 (비동기)
    * */
    public void sendDoCreateCompanyMessage(AmqMessage prevMessage, DoCreateCompanyModel model, AmqRoutingInfo routingInfo) {
        DomsCreateCompanyProducer producer = this;
